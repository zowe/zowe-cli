...
import { ImperativeExpect, Logger } from "@brightside/imperative";
 ...
 * and these utilities help containerize the tests.
 * @export
...
export class TestEnvironment {
    ...
    public static async setUp(params: ISetupEnvironmentParms): Promise<ITestEnvironment> {
        ...
        const systemProps = TestEnvironment.loadSystemTestProperties();
     ...
     *  @memberof TestEnvironment
     */
    private static loadSystemTestProperties(filePath: string = null): ITestPropertiesSchema {
        const logger: Logger = Logger.getConsoleLogger();
