...
export const ActionDefinition: ICommandDefinition = {
    ...
    "   \"bright provisioning list registry-instances\" command. Once you have\n" +
    "   obtained an instance name you can use the \"bright provisioning list\n" +
    ...
    positionals: [
        ...
        },
        {
            name: "actionname",
            type: "string",
            description: "The action name. Use the \"bright provisioning list instance-info <name>\"\n" +
