...
export function getCertificateKey(service: string, account: string): Promise<Buffer | null>
export function getCertificateKeySync(service: string, account: string): Buffer | null
