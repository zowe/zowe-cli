...
try {
    ...
    // The prebuild exists but this system cannot load it. Usually due to a missing shared
    // library such as libsecret on Linux, or security software blocking the prebuild. 
    // Warn clearly so that the user keeps a usable CLI, but is made aware that secure storage is unavailable.
    console.error([
        "",
