...
cfg_if::cfg_if! {
    if #[cfg(target_os = "windows")] {
        pub mod win;
        pub use win::{create_identity_context, delete_password, find_credentials, find_password, get_certificate, get_password, get_private_key, native_https_request, release_identity_context, set_password, set_password_with_persistence, sign_with_identity, PERSIST_ENTERPRISE};
