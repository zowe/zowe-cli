...
- Enhancement: Added support for secure certificates in keyring for Windows and macOS, Linux remains unsupported at this time. [#2325](https://github.com/zowe/zowe-cli/issues/2325)
