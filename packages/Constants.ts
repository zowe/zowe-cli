...
export class Constants {
     ...
     * @memberof Constants
     */
    public static readonly LOG_LOCATION = "brightside/logs/brightside.log";
...
`;
     ...
     * @memberof Constants
     */
    public static readonly HOME_ENV_KEY = "BRIGHTSIDE_CLI_HOME";
     ...
     * @memberof Constants
     */
    public static readonly ENV_PREFIX = "BRIGHTSIDE";
     ...
     * @memberof Constants
     */
    public static readonly HOME_DIR = "~/.brightside";
}
