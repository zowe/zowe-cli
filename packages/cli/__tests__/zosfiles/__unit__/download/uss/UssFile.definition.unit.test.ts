...
describe("zos-files download uss-file command definition", () => {
    it ("should not have changed", () => {
        const definition: ICommandDefinition = require("../../../../../src/zosfiles/download/uss/UssFile.definition").UssFileDefinition;
