...
describe("zos-files download uss-dir command definition", () => {
    it ("should not have changed", () => {
        const definition: ICommandDefinition = require("../../../../../src/zosfiles/download/ussdir/UssDir.definition").UssDirDefinition;
