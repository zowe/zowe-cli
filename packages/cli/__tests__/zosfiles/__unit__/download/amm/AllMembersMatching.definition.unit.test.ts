...
describe("zos-files download amm command definition", () => {
    it ("should not have changed", () => {
        const definition: ICommandDefinition = require("../../../../../src/zosfiles/download/am/AllMembers.definition").AllMembersDefinition;
