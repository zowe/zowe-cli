...
import { DsDefinition } from "../../../../../src/zosfiles/rename/ds/Ds.definition";

describe("DsDefinition", () => {
    it("should use the correct object for strings", () => {
        const strings = i18nEnglish.RENAME.ACTIONS.DATA_SET;
        ...
        expect(DsDefinition.options).toBeUndefined();
