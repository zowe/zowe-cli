...
describe("zos-files view uss file command definition", () => {
    it ("should not have changed", () => {
        const definition: ICommandDefinition = require("../../../../../src/zosfiles/view/uss/USSFile.definition").USSFileDefinition;
