...
describe("zos-files create uss directory command definition", () => {
    it("should not have changed", () => {
        const definition: ICommandDefinition = require("../../../../../src/zosfiles/create/ussDir/ussDir.definition").UssDirDefinition;
