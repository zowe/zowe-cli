...
describe("zos-files create listing command definition", () => {
    it("should not have changed", () => {
        const definition: ICommandDefinition = require("../../../../../src/zosfiles/create/listingPds/ListingPDS.definition").ListingPDSDefinition;
