...
describe("zos-files create cobol command definition", () => {
    it("should not have changed", () => {
        const definition: ICommandDefinition = require("../../../../../src/zosfiles/create/cobolPds/CobolPDS.definition").CobolPDSDefinition;
