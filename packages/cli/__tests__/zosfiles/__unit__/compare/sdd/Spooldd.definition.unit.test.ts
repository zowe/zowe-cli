...
describe("zos-files compare sdd command definition", () => {
    it ("should not have changed", () => {
        // eslint-disable-next-line max-len
        const definition: ICommandDefinition = require(" ../../../../../src/zosfiles/compare/sdd/Spooldd.definition").SpoolddDefinition;
