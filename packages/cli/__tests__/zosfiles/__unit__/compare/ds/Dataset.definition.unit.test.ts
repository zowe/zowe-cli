...
describe("zos-files compare ds command definition", () => {
    it ("should not have changed", () => {
        const definition: ICommandDefinition = require(" ../../../../../src/zosfiles/compare/ds/Dataset.definition").DatasetDefinition;
