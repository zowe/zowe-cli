...
describe("zos-files invoke ams-file command definition", () => {
    it ("should not have changed", () => {
        const definition: ICommandDefinition = require("../../../../../src/zosfiles/invoke/amsFile/AmsFile.definition").AmsFileDefinition;
