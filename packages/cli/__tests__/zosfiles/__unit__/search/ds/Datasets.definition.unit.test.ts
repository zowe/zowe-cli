...
describe("zos-files search ds command definition", () => {
    it ("should not have changed", () => {
        const definition: ICommandDefinition = require("../../../../../src/zosfiles/search/ds/DataSets.definition").DataSetsDefinition;
