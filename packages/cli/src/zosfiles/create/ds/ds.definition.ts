...
export const DsDefinition: ICommandDefinition = {
    ...
    options: [
        ...
        ZosFilesCreateOptions.volser,
        {
            ...
            defaultValue: CreateDefaults.DATA_SET.C.primary,
        },
        ZosFilesCreateOptions.secondary,
        {
            ...ZosFilesCreateOptions.dirblk,
            defaultValue: CreateDefaults.DATA_SET.C.dirblk,
        },
        {
            ...ZosFilesCreateOptions.recfm,
            defaultValue: CreateDefaults.DATA_SET.C.recfm,
        },
        {
            ...ZosFilesCreateOptions.blksize,
            defaultValue: CreateDefaults.DATA_SET.C.blksize,
        },
        {
            ...ZosFilesCreateOptions.lrecl,
            defaultValue: CreateDefaults.DATA_SET.C.lrecl,
        },
