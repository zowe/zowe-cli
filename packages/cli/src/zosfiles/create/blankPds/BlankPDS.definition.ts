...
/**
 * Create Blank PDS command definition containing its description, examples and/or options
...
export const BlankPDSDefinition: ICommandDefinition = {
    ...
    examples: [
        {
            description: strings.ACTIONS.DATA_SET_BLANK.EXAMPLES.EX1,
            options: "NEW.BLANK.DATASET"
        }
    ]
};
