        ...
        ACTIONS: {
            DATA_SET: {
                ...
                OPTIONS: {
                    ...
                    SAFE_REPLACE: "Specify this option as true if you wish to replace members with identical names or the content of " +
                    "the target data set. This option will prompt to confirm."
                },
                EXAMPLES: {
