...
- Enhancement: Updated `zowe daemon enable` help text to warn you that the Zowe daemon bin directory must be on your PATH after enabling daemon mode. [#2717](https://github.com/zowe/zowe-cli/pull/2717)
