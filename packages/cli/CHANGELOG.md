...
- BugFix: Updated the `zowe zos-files uss edit` command to store temp files in a dedicated subdirectory with owner-only permissions (`0o700`). [#TBD](https://github.com/zowe/zowe-cli/pull/TBD)
