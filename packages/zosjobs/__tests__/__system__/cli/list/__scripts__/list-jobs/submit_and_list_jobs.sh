...
JOBID1=`bright zos-jobs submit data-set $1 --rff jobid --rft string`
JOBID2=`bright zos-jobs submit data-set $1 --rff jobid --rft string`

echo "Listing jobs to find job IDs $JOBID1 and $JOBID2"

LIST_JOB_OUTPUT=`bright zos-jobs list jobs`
