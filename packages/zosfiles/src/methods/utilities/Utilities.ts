...
import { AbstractSession, EncodeUri, ImperativeExpect, Headers, IHeaderContent } from "@zowe/imperative";
...
export class Utilities {
    ...
    public static async putUSSPayload(session: AbstractSession, USSFileName: string, payload: any, responseTimeout?: number): Promise<Buffer> {
        ...
        const endpoint = EncodeUri.encUriPathForUss(
            path.posix.join(ZosFilesConstants.RESOURCE, ZosFilesConstants.RES_USS_FILES, USSFileName)
        );
