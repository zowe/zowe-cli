...
export default {
    ...
    COPY: {
        DESCRIPTION: "copy the contents of a data set or a data set member",
        ACTIONS: {
            DATA_SET: {
                DESCRIPTION: "Copy the contents of a data set into another existing data set",
                POSITIONALS: {
            ...
            DATA_SET_MEMBER: {
                DESCRIPTION: "Copy the contents of a data set member into another partitioned data set",
                POSITIONALS: {
                    FROMDSNAME: "The name of the data set that you want to copy from",
                    FROMDSMEMBERNAME: "The name of the data set member that you want to copy from",
                    TODSNAME: "The name of the data set that you want to copy to",
