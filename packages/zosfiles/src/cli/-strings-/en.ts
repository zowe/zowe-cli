...
export default {
        ...
        ACTIONS: {
            ...
            VSAM: {
                ...
                OPTIONS: {
                    ...
                    "date in the form yyyyddd, where yyyy is a four-digit year (maximum value: 2155) and ddd is the three-digit day of the year " +
    ...
    DOWNLOAD: {
        ...
        OPTIONS: {
            ...
            BINARY: "Download the data set content in binary mode, which means that no data conversion is performed. The data transfer process " +
