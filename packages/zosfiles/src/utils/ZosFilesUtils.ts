...
import { IO, Logger, IHeaderContent, AbstractSession, ImperativeExpect, Headers, ImperativeError } from "@zowe/imperative";
...
export class ZosFilesUtils {
    ...
    public static getDirsFromDataSet(dataSet: string) {
        ...
        if (IO.containsBacktrack(localDirectory) || localDirectory.includes(IO.FILE_DELIM + IO.FILE_DELIM)) {
