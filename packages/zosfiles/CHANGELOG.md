...
- Enhancement: Added an optional `search-exact-name` option to `ISearchOptions` to search the contents of one data set or PDS [#2529](https://github.com/zowe/zowe-cli/pull/2529)
