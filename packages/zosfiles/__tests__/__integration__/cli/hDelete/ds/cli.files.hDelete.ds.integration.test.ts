...
describe("Delete migrated Data Set", () => {
    ...
    describe("Expected failures", () => {
        it("should fail deleting a migrated data set due to missing data set name", async () => {
            const response = runCliScript(__dirname + "/__scripts__/command/command_delete_migrated_data_set.sh",
                TEST_ENVIRONMENT, [""]);
