...
describe("Create Classic Data Set", () => {
    ...
    describe("Success scenarios", () => {
        ...
        it("should display create classic help", () => {
            const response = runCliScript(__dirname + "/__scripts__/create_classic_pds_help.sh", testEnvironment);
    ...
    describe("Expected failures", () => {
        ...
        it("should fail creating a classic partitioned data set due to missing data set name", () => {
            const response = runCliScript(__dirname + "/__scripts__/command/command_create_classic_fail_missing_dataset_name.sh", testEnvironment);
