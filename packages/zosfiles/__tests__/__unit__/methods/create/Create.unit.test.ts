...
describe("Create unit tests", () => {
    describe("Create data set", () => {
        ...
        beforeEach(() => {
            ...
            headers = [ZosmfHeaders.ACCEPT_ENCODING, {"X-IBM-Data-Type": "text"}];
        });
        ...
        describe("Success scenarios", () => {
            it("should be able to create a partitioned data set (PDS)", async () => {
                ...
                const receivedHeaders = extractSpyHeaders(mySpy);
    ...
    describe("Create uss file or directory", () => {
        ...
        beforeEach(() => {
            mySpy = jest.spyOn(ZosmfRestClient, "postExpectString").mockResolvedValue("");
            headers = [{"Content-Type": "application/json"}, ZosmfHeaders.ACCEPT_ENCODING];
        });
