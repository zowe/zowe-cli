...
- BugFix: Resolved an issue where extraneous base profiles were being added to project configs if a nested profile property was updated. [#2400](https://github.com/zowe/zowe-cli/pull/2400)
