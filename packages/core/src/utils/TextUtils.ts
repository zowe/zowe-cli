...
import { format, isArray, isNumber, isString } from "util";
...
export class TextUtils {
    ...
    public static getRecommendedWidth(preferredWidth: number = TextUtils.DEFAULT_WRAP_WIDTH): number {
        ...
        const terminalWidth = yargs.terminalWidth() ?? -1;
        const maxWidth =  terminalWidth > 0 ? terminalWidth - widthSafeGuard : preferredWidth;
