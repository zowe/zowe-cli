...
- **Breaking**: `Shell.isConnectionValid` now rejects with a host key error when the host key is untrusted or changed, instead of returning `false`. [#2813](https://github.com/zowe/zowe-cli/pull/2813)
