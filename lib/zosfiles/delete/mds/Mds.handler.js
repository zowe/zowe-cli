 ...
 */
class MDSHandler extends ZosFilesBase_handler_1.ZosFilesBaseHandler {
    processWithSession(commandParameters, session) {
        return __awaiter(this, void 0, void 0, function* () {
            const { options } = commandParameters.arguments;
            return zos_files_for_zowe_sdk_1.HDelete.dataSet(session, commandParameters.arguments.dataSetName, options);
        });
    }
}
exports.default = MDSHandler;
//# sourceMappingURL=Mds.handler.js.map