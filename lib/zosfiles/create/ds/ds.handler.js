    ...
    processWithSession(commandParameters, session) {
        return __awaiter(this, void 0, void 0, function* () {
            if (commandParameters.arguments.like == null) {
                return zos_files_for_zowe_sdk_1.Create.dataSet(session, 5 /* CreateDataSetTypeEnum.DATA_SET_BLANK */, commandParameters.arguments.dataSetName, (0, Create_utils_1.generateZosmfOptions)(commandParameters.arguments));
            }
            else {
