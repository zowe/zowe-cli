...
class Handler extends zos_tso_for_zowe_sdk_1.ZosTsoBaseHandler {
    ...
    processCmd(commandParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield zos_tso_for_zowe_sdk_1.SendTso.sendDataToTSOCollect(this.mSession, commandParameters.arguments.servletKey, commandParameters.arguments.data);
