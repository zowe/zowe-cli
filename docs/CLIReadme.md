...
* [profiles](#profiles)
	* [create | cre](# profiles-create)
		...
		* [zosconnect-profile](# profiles-create-zosconnect-profile)
	* [update | upd](# profiles-update)
		...
		* [zosconnect-profile](# profiles-update-zosconnect-profile)
	* [delete | rm](# profiles-delete)
		...
		* [zosconnect-profile](# profiles-delete-zosconnect-profile)
	* [list | ls](# profiles-list)
		...
		* [zosconnect-profiles](# profiles-list-zosconnect-profiles)
	* [set-default | set](# profiles-set-default)
		...
		* [zosconnect-profile](# profiles-set-default-zosconnect-profile)
...
* [zosconnect](#zosconnect)
	* [api](# zosconnect-api)
		* [install](# zosconnect-api-install)
		* [update](# zosconnect-api-update)
		* [delete](# zosconnect-api-delete)
		* [list](# zosconnect-api-list)
		* [start](# zosconnect-api-start)
		* [stop](# zosconnect-api-stop)
		* [info](# zosconnect-api-info)
	* [apirequester](# zosconnect-apirequester)
		* [list](# zosconnect-apirequester-list)
		* [install](# zosconnect-apirequester-install)
		* [delete](# zosconnect-apirequester-delete)
		* [update](# zosconnect-apirequester-update)
		* [start](# zosconnect-apirequester-start)
		* [stop](# zosconnect-apirequester-stop)
		* [info](# zosconnect-apirequester-info)
	* [service](# zosconnect-service)
		* [list](# zosconnect-service-list)
		* [install](# zosconnect-service-install)
		* [delete](# zosconnect-service-delete)
		* [update](# zosconnect-service-update)
		* [start](# zosconnect-service-start)
		* [stop](# zosconnect-service-stop)
		* [info](# zosconnect-service-info)
* [zosmf](#zosmf)
	* [check](# zosmf-check)
...
### zosconnect-profile<a name=" profiles-create-zosconnect-profile"></a>
...
*   `profileName`		 *(string)*
	...
	* Specifies the name of the new zosconnect profile\. You can load this profile by
      using the name on commands that support the "\-\-zosconnect\-profile" option\.
...
### zosconnect-profile<a name=" profiles-update-zosconnect-profile"></a>
z/OS Connect EE connection profile
...
### zosconnect-profile<a name=" profiles-delete-zosconnect-profile"></a>
Delete a zosconnect profile\. You must specify a profile name to be deleted\. To
find a list of available profiles for deletion, issue the profiles list
...
*   `profileName`		 *(string)*
	...
	* Specifies the name of the zosconnect profile to be deleted\. You can also load
      this profile by using the name on commands that support the
      "\-\-zosconnect\-profile" option\.
...
*  Delete a zosconnect profile named profilename:

      * `$  zowe profiles delete zosconnect-profile profilename`
...
### zosconnect-profiles<a name=" profiles-list-zosconnect-profiles"></a>
z/OS Connect EE connection profile
...
*   `--show-contents`  | `--sc` *(boolean)*
	...
	* List zosconnect profiles and their contents\. All profile details will be
      printed as part of command output\.

#### Examples

*  List profiles of type zosconnect:

      * `$  zowe profiles list zosconnect-profiles`

*  List profiles of type zosconnect and display their contents:

      * `$  zowe profiles list zosconnect-profiles --sc`
...
### zosconnect-profile<a name=" profiles-set-default-zosconnect-profile"></a>
The zosconnect set default\-profiles command allows you to set the default
profiles for this command group\. When a zosconnect command is issued and no
...
*   `profileName`		 *(string)*
	...
	* Specify a
      profile for default usage within the zosconnect group\. When you issue commands
      within the zosconnect group without a profile specified as part of the command,
      the default will be loaded instead\.

#### Examples

*  Set the default profile for type zosconnect to the profile
named 'profilename':

      * `$  zowe profiles set-default zosconnect-profile profilename`
...
# zosconnect<a name="zosconnect"></a>
z/OS Connect EE plugin for Zowe CLI
## api<a name=" zosconnect-api"></a>
Manage z/OS Connect EE APIs
### install<a name=" zosconnect-api-install"></a>
Install a new API
...
*   `--zosconnect-profile`  | `--zosconnect-p` *(string)*

	* The name of a (zosconnect) profile to load for this command execution\.

### update<a name=" zosconnect-api-update"></a>
...
### delete<a name=" zosconnect-api-delete"></a>
Delete an API
...
*   `--force`  | `-f` *(boolean)*
	...
	* Whether the API should be deleted regardless of status
...
### list<a name=" zosconnect-api-list"></a>
...
### start<a name=" zosconnect-api-start"></a>
...
### stop<a name=" zosconnect-api-stop"></a>
...
### info<a name=" zosconnect-api-info"></a>
...
## apirequester<a name=" zosconnect-apirequester"></a>
Manage z/OS Connect EE API Requesters
### list<a name=" zosconnect-apirequester-list"></a>
...
### install<a name=" zosconnect-apirequester-install"></a>
...
### delete<a name=" zosconnect-apirequester-delete"></a>
...
*   `apiRequesterName`		 *(string)*

	* The name of the API Requster to delete\.

#### Options

*   `--force`  | `-f` *(boolean)*

	* Delete the API Requester regardless of status\.
...
### update<a name=" zosconnect-apirequester-update"></a>
...
*   `apiRequesterName`		 *(string)*
	...
	* The name of the API Requester to update

*   `file`		 *(string)*

	* The new ARA file for the API Requester
...
### start<a name=" zosconnect-apirequester-start"></a>
...
*   `apiRequesterName`		 *(string)*
	...
	* The name of the API Requester to start\.
...
### stop<a name=" zosconnect-apirequester-stop"></a>
...
*   `apiRequesterName`		 *(string)*
	...
	* The name of the API Requester to stop\.
...
### info<a name=" zosconnect-apirequester-info"></a>
...
## service<a name=" zosconnect-service"></a>
Manage z/OS Connect EE Services
### list<a name=" zosconnect-service-list"></a>
...
### install<a name=" zosconnect-service-install"></a>
...
### delete<a name=" zosconnect-service-delete"></a>
Delete a Service
...
*   `--force`  | `-f` *(boolean)*
	...
	* Delete the Service regardless of status\.
...
### update<a name=" zosconnect-service-update"></a>
...
*   `file`		 *(string)*
	...
	* The new SAR file for the Service
...
### start<a name=" zosconnect-service-start"></a>
...
### stop<a name=" zosconnect-service-stop"></a>
...
### info<a name=" zosconnect-service-info"></a>
